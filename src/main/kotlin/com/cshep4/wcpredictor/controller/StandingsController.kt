...
class StandingsController {
    ...
    fun getUsersLeagueList(@PathVariable(value = "id") id: Long) : ResponseEntity<List<UserLeagueOverview>> {
        val userLeagues = standingsService.retrieveUsersLeagueList(id)
